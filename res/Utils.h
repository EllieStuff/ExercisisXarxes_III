...
enum class Commands {
	DEFAULT, WELCOME, HELLO, EXIT, PLAYER_ID, SALT, CHALLENGE, ACK_WELCOME, PING_PONG, SEARCH_MATCH, MATCH_FOUND, UPDATE_GAME, MATCH_FINISHED, ACK_MATCH_FOUND, ACK_MATCH_FINISHED, PREDICTION,
