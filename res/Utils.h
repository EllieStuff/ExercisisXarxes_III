...
enum class Commands { DEFAULT = 0, LOG, SENDCARD, SHOWCARDS, LISTCARDS, CREATE_GAME, GAME_LIST, JOIN_GAME, INCORRECT_PWD, PLAYER_READY, ORGAN_QUANTITY, UPDATE_TURN, END_ROUND, PLACE_ORGAN, PLACE_INFECTION, PLACE_MEDICINE, DISCARD_CARD, PLACE_TREATMENT, LIST_CARDS, SHOW_CARDS, PWD_FILTER, NUM_PLAYERS_FILTER, NO_FILTER, SEND_TO_ALL_PLAYERS };
enum class Commands { SENDCARD = -3 , SHOWCARDS = -2, LISTCARDS = -1, CREATE_GAME = 1, GAME_LIST, JOIN_GAME, GAME_ID, INCORRECT_NAME, INCORRECT_ID, CORRECT_PWD, INCORRECT_PWD, PWD_CHECK, PROTECTED, NOT_PROTECTED, PLAYER_LIST, PLAYER_READY,
