...
enum class Commands { DEFAULT = 0, LOG, SENDCARD, SHOWCARDS, LISTCARDS, CREATE_GAME, GAME_LIST, JOIN_GAME, INCORRECT_PWD, PLAYER_READY, ORGAN_QUANTITY, UPDATE_TURN, END_ROUND, PLACE_ORGAN, PLACE_INFECTION, PLACE_MEDICINE, DISCARD_CARD, PLACE_TREATMENT, LIST_CARDS, SHOW_CARDS, PWD_FILTER, NUM_PLAYERS_FILTER, NO_FILTER };
