...
enum class Commands {CREATE_GAME = 1, GAME_LIST, JOIN_GAME, INCORRECT_PWD, ORGAN_QUANTITY, UPDATE_TURN, END_ROUND, PLACE_ORGAN, PLACE_INFECTION, PLACE_MEDICINE, PLACE_TREATMENT, DISCARD_CARD};
