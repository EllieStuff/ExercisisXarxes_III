...
enum class Commands { CREATE_GAME = 1, GAME_LIST, JOIN_GAME, GAME_ID, INCORRECT_ID, CORRECT_PWD, INCORRECT_PWD, PWD_CHECK, PROTECTED, NOT_PROTECTED, PLAYER_LIST, PLAYER_READY,
