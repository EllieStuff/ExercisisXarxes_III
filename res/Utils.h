...
enum class Commands { SENDCARD = -3 , SHOWCARDS = -2, LISTCARDS = -1, CREATE_GAME = 1, GAME_LIST, JOIN_GAME, INCORRECT_PWD, PLAYER_READY, ORGAN_QUANTITY, UPDATE_TURN, END_ROUND, PLACE_ORGAN, PLACE_INFECTION, PLACE_MEDICINE, DISCARD_CARD, PLACE_TREATMENT, LIST_CARDS, SHOW_CARDS };
