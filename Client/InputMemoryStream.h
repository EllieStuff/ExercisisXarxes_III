...
public:
	...
	bool StartListener(int localPort) 
	{
	...
	bool ReceiveConnection(std::vector<sf::TcpSocket*>* _socks) 
	{
	...
	bool disconnectClient(std::vector<sf::TcpSocket*>* _socks, sf::TcpSocket* _sock)
	{
	...
	std::string ReceiveInfo(sf::TcpSocket* _sock)
	{
		sf::Packet pack;
